...
//        bundle.putStringArrayList("test", mDatas);
//        bundle.putInt("stuff", 5); // ... save stuff
//        return bundle;
//    }
//
//    @Override
...
//            mDatas = bundle.getStringArrayList("test"); // ... load stuff
...
//    }
     ...
     */
    public void setDatasWithDrawableIcon(ArrayList<String> datas, Drawable drawable,int size, int direction){
        this.mDatas = datas;
